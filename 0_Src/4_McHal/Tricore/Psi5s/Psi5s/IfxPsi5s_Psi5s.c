 ...
 * \return None
 */
static void IfxPsi5s_Psi5s_enableModule(Ifx_PSI5S *psi5s);
 ...
 * \return None
 */
static void IfxPsi5s_Psi5s_resetModule(Ifx_PSI5S *psi5s);
...
boolean IfxPsi5s_Psi5s_initModule(IfxPsi5s_Psi5s *psi5s, const IfxPsi5s_Psi5s_Config *config)
{
    ...
    if (pins != NULL_PTR)
    {
        ...
        if (rx != NULL_PTR)
        {
            IfxPsi5s_initRxPin(rx, pins->rxMode);
        }
...
void IfxPsi5s_Psi5s_initModuleConfig(IfxPsi5s_Psi5s_Config *config, Ifx_PSI5S *psi5s)
{
    ...
    config->ascConfig.loopbackEnabled                              = FALSE;
